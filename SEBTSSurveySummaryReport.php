<?php
//SEBTS Hack
// Page lifted from ../mod/questionnaire/report.php
/// This page prints a particular instance of questionnaire
    global $SESSION, $CFG;
    require_once("../../config.php");
    require_once($CFG->dirroot.'/mod/questionnaire/lib.php');
	require_once("SEBTSSurveyBypassLogin.php");
...
//SEBTS Hack
    bypass_logincheck_for_survey_summaries($course, true, $cm);
